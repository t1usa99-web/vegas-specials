...
<p>The gold standard. From 5&ndash;8pm daily, the entire menu is half price &mdash; cocktails, wine, oysters, and yes, steaks. A 9oz filet lands at $15. There's a late-night seating from 11:59pm too.</p>
...
<p>See the full, always-updated list on our <a href="/">live happy hour tracker</a> &mdash; every listing shows when it was last confirmed.</p>` },
  { slug: "how-to-drink-in-vegas-without-going-broke", title: "How to Drink in Vegas Without Going Broke", excerpt: "A local's playbook: players cards, reverse happy hours, and the off-Strip bars where your money actually goes further.", author_id: "a_deshawn", status: "published", published_at: ago(5), read_min: 5, tag: "Guide",
...
<p>Casino loyalty cards are free and routinely unlock $3 mimosas, free beers for veterans, and drink credits. Ellis Island gives active military and vets a free house beer daily.</p>
...
<p>Two blocks off the Boulevard, prices fall off a cliff. The Arts District and Chinatown are where locals actually drink. Our <a href="/">tracker</a> filters by neighborhood.</p>` },
  { slug: "where-to-find-dollar-oysters-las-vegas", title: "Locals' Secret: Where to Find $1 Oysters in Las Vegas", excerpt: "Yes, dollar oysters still exist in this town. Here's where, when, and how to know they're fresh.", author_id: "a_marisol", status: "published", published_at: ago(9), read_min: 4, tag: "Food",
    body: `<p>Dollar oyster happy hours are one of the last great Vegas bargains. The Oyster Bar at Palace Station runs $1 oysters and is open 24/7 &mdash; a hidden gem inside an off-Strip locals casino.</p>
<h2>How to know they're fresh</h2>
<p>A high-turnover oyster bar is a safe oyster bar. Look for a line, ask what came in today, and trust the spots that move volume. We tag every seafood special with a confidence score and a "last verified" date.</p>
