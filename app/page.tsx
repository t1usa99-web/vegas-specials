  ...
  return (
    <>
      ...
      <footer className="foot">
        ...
        <p style={{ marginTop: 8 }}>Browse our <Link href="/best" style={{ color: "var(--accent)", fontWeight: 600 }}>deal guides</Link> (best happy hours, cheap drinks, eats under $10), browse <Link href="/resort" style={{ color: "var(--accent)", fontWeight: 600 }}>deals by resort</Link>, compare <Link href="/price" style={{ color: "var(--accent)", fontWeight: 600 }}>prices</Link>, <Link href="/submit" style={{ color: "var(--accent)", fontWeight: 600 }}>add a deal</Link>, read the <Link href="/blog" style={{ color: "var(--accent)", fontWeight: 600 }}>blog</Link>, or confirm prices with the venue &mdash; they change fast.</p>
      </footer>
