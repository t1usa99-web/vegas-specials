...
For an always-available item set days="Daily", start_time="All day", end_time="All day". Mark all-day ONLY when the DEAL is, not because the venue is open 24/7. Pool / dayclub deals use category "pool". Casino promotions count as deals: free slot play, match play, points multipliers, new-member sign-up bonuses, players-card perks and free-play offers \u2014 capture each with category "gaming" and put the dollar amount in "price" when stated. Skip generic marketing. If no real deals, still return cuisine/vibe with "specials":[].`;
